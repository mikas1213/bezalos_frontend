...
const policyData = [
    {title: 'Bendrosios nuostatos', policy: [
    ...
    {title: 'Įstatymų laikymasis', policy: [
    ...
    {title: 'Vartotojo įsipareigojimai', policy: [
    ...
    {title: 'Atsakomybės ribojimas', policy: [
    ...
    {title: 'Paslaugų įsigijimas', policy: [
    ...
    {title: 'Narystės nutraukimas ir pinigų grąžinimas', policy: [
    ...
    {title: 'Paslaugų nutraukimas ir pinigų gražinimas', policy: [
    ...
    {title: 'Baigiamosios nuostatos', policy: [
    ...
    {title: 'Kontaktai', policy: ['Sandra Jatulytė', 'sandra@bezalos.lt', '+370 6 921 9312']
    }
];  
...
const Accordion = () => {
    return (
        <div className={styles.accordion}>
            {policyData.map((policy, index) => <AccordionItem 
                key={index} 
                policy={policy} 
