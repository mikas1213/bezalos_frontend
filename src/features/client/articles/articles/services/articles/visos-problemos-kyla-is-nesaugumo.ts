...
export default {
	id: '085b909a-b88f-4c39-ae9a-a2918221257a',
	...
	img: '/og-articles/visos-problemos-kyla-is-nesaugumo.webp',
	...
	body: [
		...
		{
			t: 'p',
			x: 'Ne išimtis ir aš. Jauni tėvai „padovanojo” man nesaugų prieraišumo stilių. Paprastai tariant didžiulę baimę, kad šalia esantis žmogus išeis ir niekuomet nebesigrįš. Asmeniniuose santykiuose iš to kildavo didelis poreikis kontroliuoti, vėliau įvairios konfliktinės situacijos ir pan.',
		},
		{
			t: 'q',
		...
		{
			t: 'p',
			x: 'Atpažinus savo prieraišumo stilių atsiveria daug atsakymų į šiandieninį tavo santykį su savim, aplinka ar net maistu. Atpažinus kaip prieraišumo stilius reiškiasi tavo gyvenime, galimas nuoseklus darbas iki saugaus prieraišumo, kurio dėka gali kurti saugumu ir pasitikėjimu grįstus santykius, gerai jautiesi tiek viena, tiek tarp kitų žmonių, ramiai priimi kitokias kitų žmonių nuomones, brėžti ribas ir gebi ramiai spręsti kilusius konfliktus.',
		},
		{
			t: 'p',
