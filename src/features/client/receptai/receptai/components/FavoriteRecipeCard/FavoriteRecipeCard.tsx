...
import styles from './FavoriteRecipeCard.module.scss';

export const FavoriteRecipeCard = ({ recipe }: { recipe: FavoriteRecipe }) => {
	return (
		<div className={styles.favRecipe}>
			<Link to={`/receptai/${recipe.slug}`} className={styles.anchor}>
				<div className={styles.imageContainer}>
					<img src={recipe.image_s} alt={recipe.title} className={styles.image} />
				</div>
