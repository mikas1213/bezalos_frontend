				...
				<Grid space="clamp(2rem, 4vw, 6rem)" className={styles.aboutContainer} min="200px">
					...
					>
						...
						<Stack space="var(--s-lg-mobi)">
							<p>
								Čia ramybę ras tos, kurios pavargo nuo nuolatinio savęs alinimo vis nauja dieta, ataugančio su kaupu
								svorio ar kitų savęs ribojimų. Šioje bendruomenėje išmoksi sveikatai palankios mitybos pagrindų,
								kurie be ribojimo leis tau atkurti sveiką santykį su maistu.
							</p>
							<p>
								Taip pat padėsiu tau geriau pažinti save, savo mintis, emocijas ir kūno pojūčius, kurie tave atveda
								į apsivalgymus ar kitus iššūkius. Kartu galime įveikti visus, su valgymu susijusius sunkumus 💚
							</p>
						</Stack>
