...
import type { AnswerValue } from '../../pages/types';
import type { AnswerItem } from '../../pages/types';
...
export const Answer = ({ onClick, index, currentAnswer, option }: AnswerItemProps) => {
	const answerClasses = [styles.answer, currentAnswer === option.value && styles.active].filter(Boolean).join(' ');
