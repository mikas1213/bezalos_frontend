...
import { calculateScores, getHighestScore } from '../utils/calculateScores';

import { answerItems, questions, resultItems } from './constants';
import type { AnswerMap, AnswerValue, QuestionCategory, QuestionItem } from './types';

import styles from './ValgymoTestasPage.module.scss';
...
const ValgymoTestasPage = () => {
	...
	return (
		<>
			...
			/>
			<TestLayout>
				<ProgressBar currentPage={currentPage} questionLength={questions.length} progress={progress} />
				...
				<Box className={styles.buttonsContainer}>
					<Button onClick={handlePrevious} variant="Atgal" disabled={currentPage === 0} />
					<Button
						onClick={handleNext}
