	...
	rows: [
		...
		},
		{
			...
			items: [
				...
				{text: 'Narystė įsigalioja automatiškai nuo apmokėjimo momento ir galioja 30 kalendorinių dienų.'},
				{text: 'Prenumeratos suma nuskaitoma automatiškai kas mėnesį tol, kol Pirkėjas nenutraukia prenumeratos savo paskyroje arba neinformuoja sandra@bezalos.lt apie pageidavimą nutraukti prenumeratą.'},
