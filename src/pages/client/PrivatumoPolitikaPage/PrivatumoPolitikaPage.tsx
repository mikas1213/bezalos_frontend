...
import { Box, Container, Accordion } from '../../../components/Shared';
...
const data: AccordionData = {
	...
	rows: [
		...
		},
		{
			title: '4. Slapukai',
			items: [
				{text: 'Šioje svetainėje naudojami saugumo slapukai. Šie slapukai yra būtini, norint naudotis www.senas.bezalos.lt paslaugomis. Norint nesinaudoti šiais slapukais, prašome nesinaudoti www.senas.bezalos.lt paslaugomis, kitu atveju, mes tai priimsime kaip sutikimą jais naudotis.'}
			]
		},
		{
