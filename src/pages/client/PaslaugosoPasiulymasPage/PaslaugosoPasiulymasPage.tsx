...
import NereikiaPaslautosPage from '../NereikiaPalaugosPage/NereikiaPaslaugosPage';
import {
    HeroSection,
    TagLine,
    MainBenefits,
    FeatureCard,
    PriceCard
} from '../../../features/client/paslaugospasiulymas/components';
...
const PaslaugosoPasiulymasPage = () => {
    ...
    if (result === COOKIES.TEST_RESULT.values.good as ServiceType) {
        return <NereikiaPaslautosPage />
    }
