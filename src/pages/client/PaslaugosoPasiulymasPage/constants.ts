import { Heart, Shield, Users, TrendingUp, Gift, Calendar } from 'lucide-react';
...
export const services: Services = {
    ...
    [COOKIES.TEST_RESULT.values.emocinis]: {
        ...
        description: 'Specialiai sukurta paslauga toms, kurios valgo reaguodamos į stresą, liūdesį ar nerimą. Išmoksi atpažinti emocijas ir valdyti jas sveikais būdais.',
        mainBenefits: [
    ...
    [COOKIES.TEST_RESULT.values.isorinis]: {
        ...
        icon: '💚',
        tagline: 'Atrask ramybę su maistu',
        description: 'Skirta toms, kurios užkandžiauja matydamos skanų maistą ar dėl to, kad valgo kiti. Išmoksi klausytis tikrojo alkio ir sotumo signalų.',
        mainBenefits: [
            'Atpažinsi savo tikrąjį alkį',
            'Sumažinsi užkandžiavimą 75%',
            'Virtuvės narystė dovanų'
        ],
        features: [
            { icon: Heart, title: 'Dovana', desc: 'Naystė Virtuvėje' },
    ...
    [COOKIES.TEST_RESULT.values.ribojantis]: {
        ...
        icon: '💚',
        tagline: 'Atrask ramybę su maistu',
        description: 'Toms, kurios nuolat kontroliuoja maistą ir jaudinasi dėl kūno svorio. Išmok maitintis laisvai ir intuityviai.',
        mainBenefits: [
    ...
    [COOKIES.TEST_RESULT.values.main]: {
        ...
        icon: '💚',
        tagline: 'Atrask ramybę su maistu',
        description: 'Toms, kurios nuolat persivalgo ir užkandžiauja tiek dėl patiriamų emocijų, tiek dėl intensyvių dietų patirčių, tiek dėl to, kad maistas lengvai prieinamas. Išmok gyventi be įkyrių minčių apie mitybą ir maistą',
        mainBenefits: [
            'Pagerinsi santykį su maistu per 4 savaites',
            'Sumažinsi įkyrių mninčių apie mitybą ir maistą 80%',
